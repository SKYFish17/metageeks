 ...
 */
function bda_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'bda_remove_default_customizer_sections', 15 );
 ...
 */
function bda_include_custom_controls() {
...
add_action( 'customize_register', 'bda_include_custom_controls', -999 );
 ...
 * @author WebDevStudios
 */
function bda_customize_scripts() {
	wp_enqueue_script( 'metageeks-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
add_action( 'customize_preview_init', 'bda_customize_scripts' );
 ...
 */
function bda_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = [
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'bda_copyright_text' => '.site-info',
	];
...
add_action( 'customize_register', 'bda_selective_refresh_support' );
 ...
 */
function bda_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'bda_live_preview_support', 999 );
