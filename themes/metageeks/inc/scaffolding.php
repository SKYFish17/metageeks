 ...
 */
function bda_display_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
	...
	$allowed_tags = bda_scaffolding_allowed_html();
	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'metageeks' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'metageeks' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'metageeks' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'metageeks' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'metageeks' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'metageeks' ); ?>:</strong></p>
 ...
 */
function bda_scaffolding_allowed_html() {
 ...
 */
function bda_display_global_scaffolding_section( $args = [] ) {
	// Set defaults.
	$defaults = [
 ...
 * @author Carrie Forde
 */
function bda_hook_theme_scaffolding() {
...
add_action( 'bda_scaffolding_content', 'bda_hook_theme_scaffolding' );
