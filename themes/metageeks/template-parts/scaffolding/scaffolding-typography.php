...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading"><?php esc_html_e( 'Typography', 'metageeks' ); ?></h2>

	<?php
	// H1.
	bda_display_scaffolding_section(
		[
			'title'       => 'H1',
	...
	bda_display_scaffolding_section(
		[
			...
			'usage'       => '<del>MetaGeeks</del>',
			'output'      => '<p>We use <del>MetaGeeks</del> wd_s to build themes.</p>',
		]
	);
