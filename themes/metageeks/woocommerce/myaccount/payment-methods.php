...
<div class="metageeks-payment-methods">
	...
	<div class="metageeks-account__title">Payment methods</div>
	...
	<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></a>
	<?php endif; ?>
