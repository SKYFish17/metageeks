...
// Get instance of the Points_Rewards_For_WooCommerce_Public class.
...
?>
<div class="metageeks-points">

	<div class="metageeks-points__header">
		<div class="metageeks-account__title">Loyalty points</div>

		<a href="<?php echo esc_url( wc_get_endpoint_url( 'view-log' ) ); ?>">
			<?php esc_html_e( 'View Point Log', 'points-and-rewards-for-woocommerce' ); ?>
		</a>
	</div>

	<?php if ( isset( $mwb_ways_to_gain_points_value ) && ! empty( $mwb_ways_to_gain_points_value ) ) : ?>
		<div class="metageeks-points__description">
			<?php
			...
			echo esc_html( $mwb_ways_to_gain_points_value );
			?>
		</div>
	<?php endif; ?>

	<div class="metageeks-points__grid">
		...
		?>
		<div class="metageeks-points-card">
			<div class="metageeks-points-card__number">
				<?php echo ( isset( $get_points ) && null !== $get_points ) ? esc_html( number_format( (float) $get_points ) ) : 0; ?>
			</div>
			<div class="metageeks-points-card__title">Loyalty points</div>
			<div class="metageeks-points-card__subtitle">(<?php echo esc_html( $coupon_redeem_points ) . esc_html__( ' loyalty points = ', 'ultimate-woocommerce-points-and-rewards' ) . wc_price( $coupon_redeem_price ); ?>)</div>
			<div class="metageeks-points-card__description"><?php echo $mwb_text_points_value ? esc_html( $mwb_text_points_value ) : 'Continue shopping and earn more points.'; ?></div>
			<a class="metageeks-points-card__button mg-button" href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>">Earn more</a>
		</div>

		<div class="metageeks-points-card">
			<div class="metageeks-points-card__number">
				<?php echo wc_price( (int) $get_points / (int) $coupon_redeem_points ); ?>
			</div>
			<div class="metageeks-points-card__title">Discount available!</div>
			<div class="metageeks-points-card__subtitle">&nbsp;</div>
			<div class="metageeks-points-card__description">
				Redeem your point now!<br>
				& Get <?php echo wc_price( (int) $get_points / (int) $coupon_redeem_points ); ?> off your purchase!
			</div>
			<button class="metageeks-points-card__button metageeks-points-toggle-coupon mg-button" type="button">Redeem discount</button>
		</div>
...
?>
	...
	<div class="metageeks-points-coupon" style="display:none;">
		<?php do_action( 'mwb_wpr_add_coupon_generation', $user_id ); ?>
	</div>
